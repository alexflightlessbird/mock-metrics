...
export default function DeleteSchoolModal ({ opened, onClose, school, onSubmit }) {
    ...
    return (
        ...
        >
            <Text>Woah, hold up! Are you sure you want to delete{school?.name?.length > 0 ? " " + school.name : ""}?</Text>
