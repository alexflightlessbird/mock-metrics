import { Modal, TextInput, Select, Checkbox, Button, Space, Input, NumberInput } from "@mantine/core";
...
export default function AddCaseModal ({ opened, onClose, onSubmit }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFormValues({ name: "", year: new Date().getFullYear(), type: "civil", area: "", is_active: true });
            onClose();
        } finally {
            setIsLoading(false);
        }
