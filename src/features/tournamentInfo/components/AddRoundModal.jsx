import { Modal, Radio, Button, Group, Stack, Text, Box, Select, MultiSelect, Table } from "@mantine/core";
...
export default function AddRoundModal({ opened, onClose, existingRounds, caseType, nationalsTournament = false, tournamentId, teamId, caseId }) {
    ...
    const { data: students, isLoading: studentsLoading } = useTeamStudents(teamId);
    ...
    if (caseLoading || studentsLoading) return (
        <Modal opened={opened} onClose={onClose} title="Loading..." size="md" centered>
            <Box py="xl">
                <Loader />
            </Box>
        </Modal>
    ...
    const validateCurrentPage = () => {
        switch (activePage) {
            ...
            case 1:
                return formData.attorneys.length === 3 && formData.witnesses.length === 3;
            default:
                return true;
        }
    }
    ...
    const pWitnessOptions = [
        {
            ...
            items: pWitnesses.map((w) => {
                return {
                    ...w,
                    disabled: formData.pw1 === w.value || formData.pw2 === w.value || formData.pw3 === w.value || formData.dw1 === w.value || formData.dw2 === w.value || formData.dw3 === w.value
                }
            })
        },
        {
    ...
    const pages = [
        ...
        <Stack key={1}>
            <Text size="sm" c="dimmed">Select the students participating in this round. The order doesn't matter.</Text>
            <MultiSelect
        ...
        <Stack key={2}>
            <Text size="sm" c="dimmed">Assign {caseType === "civil" ? "Plaintiff" : caseType === "criminal" ? "Prosecution" : "Plaintiff/Prosecution"} Witnesses</Text>
            <Select
                data={pWitnessOptions}
                value={formData.pw1}
                onChange={(value) => handleInputChange("pw1", value)}
                clearable
                label={`${caseType === "civil" ? "Plaintiff" : caseType === "criminal" ? "Prosecution" : "Plaintiff/Prosecution"} Witness 1`}
            />
            <Select
                data={pWitnessOptions}
                value={formData.pw2}
                ...
                clearable
                label={`${caseType === "civil" ? "Plaintiff" : caseType === "criminal" ? "Prosecution" : "Plaintiff/Prosecution"} Witness 2`}
            />
            <Select
                data={pWitnessOptions}
                value={formData.pw3}
                ...
                clearable
                label={`${caseType === "civil" ? "Plaintiff" : caseType === "criminal" ? "Prosecution" : "Plaintiff/Prosecution"} Witness 3`}
            />
            <Text size="sm" c="dimmed">Assign Defense Witnesses</Text>
            <Select
                ...
                <Table striped highlightOnHover withTableBorder fz="xs">
                    ...
                    <Table.Tbody>
                        <Table.Tr>
                            ...
                            <Table.Td>
                                <Select 
                                    data={attorneyStudentOptions.map(a => { return { ...a, disabled: formData.pRoles.p1 === a.value || formData.pRoles.p14 === a.value } })}
                        ...
                        <Table.Tr>
                            <Table.Td>P1<br />{getWitnessName(formData.pw1)}</Table.Td>
                            <Table.Td>
                                <Select 
                                    data={attorneyStudentOptions.map(a => { return { ...a, disabled: formData.pRoles.p2 === a.value || formData.pRoles.p5 === a.value || formData.pRoles.p8 === a.value } })} 
                            ...
                            <Table.Td>
                                <Select
                                    data={witnessStudentOptions.map(w => { return { ...w, disabled: formData.pRoles.p3 === w.value || formData.pRoles.p6 === w.value || formData.pRoles.p9 === w.value } })} 
                        ...
                        <Table.Tr>
                            <Table.Td>P2<br />{getWitnessName(formData.pw2)}</Table.Td>
                            <Table.Td>
                                <Select 
                                    data={attorneyStudentOptions.map(a => { return { ...a, disabled: formData.pRoles.p2 === a.value || formData.pRoles.p5 === a.value || formData.pRoles.p8 === a.value } })} 
                        ...
                        <Table.Tr>
                            <Table.Td>P3<br />{getWitnessName(formData.pw3)}</Table.Td>
                            <Table.Td>
                                <Select 
                                    data={attorneyStudentOptions.map(a => { return { ...a, disabled: formData.pRoles.p2 === a.value || formData.pRoles.p5 === a.value || formData.pRoles.p8 === a.value } })} 
                        ...
                        <Table.Tr>
                            <Table.Td>D1<br />{getWitnessName(formData.dw1)}</Table.Td>
                            <Table.Td>
                                <Select 
                                    data={attorneyStudentOptions.map(a => { return { ...a, disabled: formData.pRoles.p11 === a.value || formData.pRoles.p12 === a.value || formData.pRoles.p13 === a.value } })} 
                        ...
                        <Table.Tr>
                            <Table.Td>D2<br />{getWitnessName(formData.dw2)}</Table.Td>
                            <Table.Td>
                                <Select 
                                    data={attorneyStudentOptions.map(a => { return { ...a, disabled: formData.pRoles.p11 === a.value || formData.pRoles.p12 === a.value || formData.pRoles.p13 === a.value } })} 
                        ...
                        <Table.Tr>
                            <Table.Td>D3<br />{getWitnessName(formData.dw3)}</Table.Td>
                            <Table.Td>
                                <Select 
                                    data={attorneyStudentOptions.map(a => { return { ...a, disabled: formData.pRoles.p11 === a.value || formData.pRoles.p12 === a.value || formData.pRoles.p13 === a.value } })} 
                ...
                <Table striped highlightOnHover withTableBorder fz="xs">
                    ...
                    <Table.Tbody>
                        <Table.Tr>
                            ...
                            <Table.Td>
                                <Select
                                    data={attorneyStudentOptions.map(a => { return { ...a, disabled: formData.dRoles.d1 === a.value || formData.dRoles.d14 === a.value } })}
                        ...
                        <Table.Tr>
                            ...
                            <Table.Td>
                                <Select
                                    data={attorneyStudentOptions.map(a => { return { ...a, disabled: formData.dRoles.d2 === a.value || formData.dRoles.d3 === a.value || formData.dRoles.d4 === a.value } })}
                        ...
                        <Table.Tr>
                            ...
                            <Table.Td>
                                <Select
                                    data={attorneyStudentOptions.map(a => { return { ...a, disabled: formData.dRoles.d5 === a.value || formData.dRoles.d8 === a.value || formData.dRoles.d11 === a.value } })}
                            ...
                            <Table.Td>
                                <Select
                                    data={witnessStudentOptions.map(w => { return { ...w, disabled: formData.dRoles.d6 === w.value || formData.dRoles.d9 === w.value || formData.dRoles.d12 === w.value } })}
    ...
    return (
        <Modal opened={opened} onClose={onClose} title={`Add Round (Step ${activePage + 1} of 4)`} size="xl" centered styles={{ content: { maxHeight: "80%", overflowY: "auto" }, body: { overflowY: "auto" } }}>
            {pages[activePage]}
