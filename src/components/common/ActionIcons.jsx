...
function EditIcon({ onClick }) {
    ...
    return (
        <ActionIcon variant="subtle" onClick={onClick} style={{ color: theme.colors.primaryBlue[0] }}>
...
function DeleteIcon({ onClick }) {
    ...
    return (
        <ActionIcon variant="subtle" onClick={onClick} style={{ color: theme.colors.red[5] }}>
