...
export default function Logo ({ backgroundColor = "#0a1f3c", borderColor = "#f7f5f3", insideBorderColor = "#0a1f3c", gavelColor = "#f7f5f3", barsColor = "#2dace6", scale = 1 }) {
    const ids = useIds(33);
    ...
    return (
        ...
        <div className={styles.logoContainer} style={{ "--scale-size": scale }} aria-hidden="true">
            <svg 
