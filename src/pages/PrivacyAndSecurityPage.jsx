  ...
  return (
    <>
      <BasePage titleText="Privacy Policy">
        ...
        <Text>
          We collect minimal personal data required for authentication and
          account management. This includes email addresses and authentication
        ...
        <Text>
          Our site uses strictly necessary cookies for authentication. These
        ...
        <Text>
          ...
          personal data. Contact support for data-related requests.
        </Text>
      ...
      <BasePage titleText="Security Practices">
        ...
        <Text>
          Authentication cookies are marked as Secure and HttpOnly to prevent
          XSS attacks.
        </Text>
        ...
        <Text>
          We use the brower's local storage to remember your non-sensitive
          preferences (such as layouts and themes) for a better user experience.
          This data never leaves your device, is not used for tracking, and
